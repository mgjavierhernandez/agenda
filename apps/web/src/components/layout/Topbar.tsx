    ...
    <header className="sticky top-0 z-30 bg-white border-b border-gray-200 px-4 h-16 flex items-center justify-between">
      <div className="flex items-center gap-4">
        ...
        <div className="relative">
          ...
          >
            ...
            <span className="hidden sm:inline">{selectedInstitution?.name || 'Select institution'}</span>
          ...
          {showInstMenu && otherInstitutions.length > 0 && (
            <div role="menu" className="absolute top-full left-0 mt-1 w-64 bg-white border border-gray-200 rounded-lg shadow-lg py-1 z-50">
      ...
      <div className="flex items-center gap-3">
        ...
        >
          ...
          {unreadCount > 0 && (
            <span className="absolute -top-0.5 -right-0.5 inline-flex items-center justify-center rounded-full bg-red-500 px-1.5 py-0.5 text-xs font-bold text-white min-w-[18px]" aria-hidden="true">
        ...
        <div className="relative">
          ...
          {showUserMenu && (
            <div role="menu" className="absolute top-full right-0 mt-1 w-48 bg-white border border-gray-200 rounded-lg shadow-lg py-1 z-50">
              <button
                role="menuitem"
                onClick={() => {
                  logout();
